...
import myAnimation from "/src/assets/SculptureStudio.json";
  ...
  return (
    <div className="flex flex-col gap-2 mt-5">
      ...
      <p className="text-lg break-words max-w-screen-lg">
        No hay requisitos previos para realizar el curso. Todos los temas se
        explicaran de manera que cualquiera pueda entenderlos. Ademas se
        entregaran fotocopias de planos y partes importantes para que el alumno
        tenga. Y por ultimo, tambien habra disponible material digital para
        descargar.
      </p>
      <div className="flex flex-row max-w-screen-lg">
        ...
        <Lottie animationData={myAnimation} loop={true} className="w-[50%]" />
      </div>
    </div>
  );
};
